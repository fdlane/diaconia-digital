...
const publicEnv = {
  ...
  EXPO_PUBLIC_CLERK_JWT_TEMPLATE:
    process.env.EXPO_PUBLIC_CLERK_JWT_TEMPLATE || process.env.NEXT_PUBLIC_CLERK_JWT_TEMPLATE || "diaconia-api",
  NEXT_PUBLIC_CLERK_JWT_TEMPLATE:
    process.env.NEXT_PUBLIC_CLERK_JWT_TEMPLATE || process.env.EXPO_PUBLIC_CLERK_JWT_TEMPLATE || "diaconia-api",
};
