...
export EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY="${EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY:-${NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:-${CLERK_PUBLISHABLE_KEY:-}}}"
export NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY="${NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:-${EXPO_PUBLIC_CLERK_PUBLISHABLE_KEY:-${CLERK_PUBLISHABLE_KEY:-}}}"
export EXPO_PUBLIC_CLERK_JWT_TEMPLATE="${EXPO_PUBLIC_CLERK_JWT_TEMPLATE:-${NEXT_PUBLIC_CLERK_JWT_TEMPLATE:-diaconia-api}}"
export NEXT_PUBLIC_CLERK_JWT_TEMPLATE="${NEXT_PUBLIC_CLERK_JWT_TEMPLATE:-${EXPO_PUBLIC_CLERK_JWT_TEMPLATE:-diaconia-api}}"
